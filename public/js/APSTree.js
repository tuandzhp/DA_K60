...
$(document).ready(function () {
  ...
  $('#createNewLocation').click(function () {
    ...
    let selectedLocationNode = $('#locationsTree')
      .jstree(true)
      .get_selected(true)[0]
    let data = {
  ...
  $('#deleteLocationTree').click(function () {
    $('#importModelLocationFromModelProgressBar .progress-bar')
      .css('width', '0%')
    ...
    jQuery.ajax({
      ...
      success: function (data) {
        ...
        $('#importModelLocationFromModelProgressBar p').text(
          '1/2 Fetching and importing locations data from model ...',
        )
        ...
        jQuery.post({
          ...
          success: function (data) {
            console.log(
              `Completed! Successfully imported locations from model for project \`${projectId}\`.`,
              data,
            )
            ...
            $('#importModelLocationFromModelProgressBar p').text(
              '2/2 Imported locations from model ...',
            )
